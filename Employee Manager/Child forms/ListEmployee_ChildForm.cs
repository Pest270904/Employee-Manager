...
namespace Employee_Manager.Child_Forms
{
    public partial class ListEmployee_ChildForm : Form
    {
        ...
        private void LoadData()
        {
            ...
            {
                //MessageBox.Show(room.Value.roomID);
            }
            ...
            foreach (var roomEntry in result)
            {
                ...
                foreach (var userInfo in result2)
                {
                    ...
                    MessageBox.Show(userInfo.Value.name.ToString());
        ...
        private void searchTB_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                (employeeGridView.DataSource as DataTable).DefaultView.RowFilter = string.Format("employeeID='{0}'", searchTB.Text);
            }
        }
